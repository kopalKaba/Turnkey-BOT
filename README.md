...
## Features
  ...
  - Auto Perform Transfer to Random Address
  - Multi Accounts

## Requiremnets

- Make sure you have Python3.9 or higher installed and pip.
- ETH Sepolia, u can get it from [Google Clod Web3](https://cloud.google.com/application/web3/faucet/ethereum/sepolia)
...
### Note: Check your web3, eth-utils and eth-account libraries version first. If not same with version in requirements.txt, u must uninstall that library.
